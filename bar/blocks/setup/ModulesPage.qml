      ...
      ColumnLayout {
        ...
        RowLayout {
          ...
          ColumnLayout {
            ...
            RowLayout { Layout.fillWidth: true; Label { text: "Bluetooth"; Layout.preferredWidth: 110; color: Globals.popupText !== "" ? Globals.popupText : "#FFFFFF" } Item { width: 0 } Switch { checked: Globals.showBluetooth; onToggled: { Globals.showBluetooth = checked; Globals.saveTheme() } } }
          ...
          ColumnLayout {
            ...
            RowLayout { Layout.fillWidth: true; Label { text: "Window Selector"; Layout.preferredWidth: 110; color: Globals.popupText !== "" ? Globals.popupText : "#FFFFFF" } Item { width: 0 } Switch { checked: Globals.showWindowSelector; onToggled: { Globals.showWindowSelector = checked; Globals.saveTheme() } } }
            ...
            RowLayout { Layout.fillWidth: true; Label { text: "Weather"; Layout.preferredWidth: 110; color: Globals.popupText !== "" ? Globals.popupText : "#FFFFFF" } Item { width: 0 } Switch { checked: Globals.showWeather; onToggled: { Globals.showWeather = checked; Globals.saveTheme() } } }
            RowLayout { Layout.fillWidth: true; Label { text: "Battery"; Layout.preferredWidth: 110; color: Globals.popupText } Item { width: 0 } Switch { checked: Globals.showBattery; onToggled: { Globals.showBattery = checked; Globals.saveTheme() } } }
